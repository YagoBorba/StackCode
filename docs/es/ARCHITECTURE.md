...
*Esta es una traducción del documento original en inglés. Para la versión más actualizada, consulte [docs/ARCHITECTURE.md](../ARCHITECTURE.md).*
...
El documento original completo está disponible en: [**📐 Guía de Arquitectura (English)**](../ARCHITECTURE.md)
