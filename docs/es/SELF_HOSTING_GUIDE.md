...
*Esta es una traducción del documento original en inglés. Para la versión más actualizada, consulte [docs/SELF_HOSTING_GUIDE.md](../SELF_HOSTING_GUIDE.md).*
...
El documento original completo está disponible en: [**🚀 Guía de Auto-hospedaje (English)**](../SELF_HOSTING_GUIDE.md)
...
*Para la documentación en inglés, visite [docs/](../)*
