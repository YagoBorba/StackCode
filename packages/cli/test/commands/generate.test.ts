...
describe('Generate Command', () => {
  ...
  describe('Non-Interactive Mode', () => {
    it('should generate a README.md when specified as an argument', async () => {
      ...
      expect(mockedFs.writeFile).toHaveBeenCalledWith(expect.stringContaining('README.md'), mockContent);
    ...
    it('should generate a .gitignore when specified as an argument', async () => {
      ...
      // Assert
      expect(mockedCore.generateGitignoreContent).toHaveBeenCalledWith(['node-ts']);
      expect(mockedFs.writeFile).toHaveBeenCalledWith(expect.stringContaining('.gitignore'), mockContent);
  ...
  describe('Interactive Mode', () => {
    it('should generate selected files when no argument is provided', async () => {
      // Arrange
      mockedInquirer.prompt.mockResolvedValue({ filesToGenerate: ['readme', 'gitignore'] });
      ...
      expect(mockedFs.writeFile).toHaveBeenCalledWith(expect.stringContaining('README.md'), '# README');
      expect(mockedFs.writeFile).toHaveBeenCalledWith(expect.stringContaining('.gitignore'), 'node_modules');
    });
