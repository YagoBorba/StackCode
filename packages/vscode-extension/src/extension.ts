...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.window.registerWebviewViewProvider('stackcode.dashboard', dashboardProvider),
        vscode.window.registerTreeDataProvider('stackcode.projectView', projectViewProvider)
    );
