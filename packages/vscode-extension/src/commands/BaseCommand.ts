...
export abstract class BaseCommand {
    ...
    protected async runTerminalCommand(command: string, cwd?: string): Promise<void> {
    ...
    protected async confirmAction(message: string, confirmText: string = 'Yes'): Promise<boolean> {
