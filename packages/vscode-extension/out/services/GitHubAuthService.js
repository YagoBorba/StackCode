...
class GitHubAuthService {
  ...
  async login() {
    try {
      ...
      vscode.window.showErrorMessage(
        `Failed to authenticate with GitHub: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
      throw error;
    }
  }
  ...
  async logout() {
    try {
      ...
      vscode.window.showErrorMessage(
        `Failed to logout from GitHub: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  }
  /**
