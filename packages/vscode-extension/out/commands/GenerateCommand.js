    ...
    async generateReadme() {
        try {
            ...
            try {
                ...
                const overwrite = await this.confirmAction((0, i18n_1.t)("vscode.generate.readme_exists_overwrite"), (0, i18n_1.t)("vscode.generate.overwrite"));
                if (!overwrite) {
                    return;
                }
            }
            ...
            vscode.window.withProgress({
                ...
                progress.report({ increment: 50, message: (0, i18n_1.t)("vscode.generate.running_generator") });
            ...
            this.showSuccess((0, i18n_1.t)("vscode.generate.readme_has_been_generated"));
            // Ask if user wants to open the file
            const openFile = await vscode.window.showInformationMessage((0, i18n_1.t)("vscode.generate.would_you_like_open_readme"), (0, i18n_1.t)("vscode.generate.open_file"));
            ...
            this.showError((0, i18n_1.t)("vscode.generate.failed_generate_readme", { error: String(error) }));
        }
    }
    async generateGitignore() {
        try {
            ...
            try {
                ...
                const overwrite = await this.confirmAction((0, i18n_1.t)("vscode.generate.gitignore_exists_overwrite"), (0, i18n_1.t)("vscode.generate.overwrite"));
                if (!overwrite) {
                    return;
                }
            }
            ...
            const projectType = await vscode.window.showQuickPick([
                ...
                { label: "flutter", description: (0, i18n_1.t)("vscode.generate.stacks.flutter") },
                { label: "swift", description: (0, i18n_1.t)("vscode.generate.stacks.swift") },
                { label: "android", description: (0, i18n_1.t)("vscode.generate.stacks.android") },
            ], {
            ...
            this.showSuccess((0, i18n_1.t)("vscode.generate.gitignore_has_been_generated"));
            // Ask if user wants to open the file
            const openFile = await vscode.window.showInformationMessage((0, i18n_1.t)("vscode.generate.would_you_like_open_gitignore"), (0, i18n_1.t)("vscode.generate.open_file"));
            if (openFile === (0, i18n_1.t)("vscode.generate.open_file")) {
            ...
            this.showError((0, i18n_1.t)("vscode.generate.failed_generate_gitignore", { error: String(error) }));
        }
    }
}
