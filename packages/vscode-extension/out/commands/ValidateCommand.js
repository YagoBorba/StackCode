    ...
    async execute() {
        try {
            ...
            vscode.window.withProgress({
                ...
                progress.report({ increment: 0, message: (0, i18n_1.t)("vscode.validate.running_validation") });
                ...
                progress.report({ increment: 100, message: (0, i18n_1.t)("vscode.validate.validation_completed") });
            });
